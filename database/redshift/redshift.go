...
func (p *Redshift) SetSourceDriver(sourceDrv source.Driver) error {
...
func (p *Redshift) SetVersion(version int, dirty bool, forced bool, knownDirection *source.Direction) (*source.Direction, error) {
...
func (p *Redshift) ListAppliedVersions() ([]int, error) {
	// Not implemented
	return []int{}, nil
}
